 ...
 */
mxGraph.prototype.collapsedImage = new mxImage('/assets/src/images/collapsed.gif', 9, 9);
 ...
 */
mxGraph.prototype.expandedImage = new mxImage('/assets/src/images/expanded.gif', 9, 9);
...
mxGraph.prototype.createEdge = function(parent, id, value, source, target, style)
{
    ...
    var edge = new mxCell(node, new mxGeometry(0,0,0,0), style);
    edge.setId(id);
    edge.setEdge(true);
    ...
    var cell1 = new mxCell(node, new mxGeometry(-0.85, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=14;');
    ...
    var cell2 = new mxCell(node2, new mxGeometry(0.85, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=14;');
    ...
    var cell2 = new mxCell(node2, new mxGeometry(0.85, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=14;');
    cell2.geometry.relative = true;
    cell2.setConnectable(false);
    cell2.vertex = true;
    edge.insert(cell2);
...
mxGraph.prototype.moveCells = function(cells, dx, dy, clone, target, evt, mapping)
{
	for(var i=0; i<cells.length ; i++)
	{
		var value = this.getModel().getValue(cells[i]);
		if(value != undefined && value instanceof Object )
		{
			if(value.getAttribute('Type') === 'Stereotype')
				cells[i] = cells[i].getParent();
		}
	}
...
{
	var value = this.getModel().getValue(cell);
	if(value != undefined && value instanceof Object )
	{
		if(value.getAttribute('Type') === 'Stereotype')
			this.getSelectionModel().setCell(cell.getParent());
		else 
...
mxGraph.prototype.addSelectionCell = function(cell)
{
	...
	{
		if(value.getAttribute('Type') === 'Stereotype')
			this.getSelectionModel().addCell(cell.getParent());
		else 
