...
EditorUi.prototype.createUi = function()
{
	...
	var xml = mxUtils.load("http://localhost:8080/profile");
	var stereotype = JSON.parse(xml.getText());



	// Creates the sidebar
	this.sidebar = (this.editor.chromeless) ? null : this.createSidebar(this.sidebarContainer,stereotype);
	...
	this.format = (this.editor.chromeless || !this.formatEnabled) ? null : this.createFormat(this.formatContainer,stereotype);
...
EditorUi.prototype.createStatusContainer = function()
{
	...
	container.className = 'geItem';
    container.setAttribute('style', 'background-color:#1eff00');
...
EditorUi.prototype.setStatusSaved = function()
{
    this.statusContainer.innerHTML = "Saved";
    this.statusContainer.setAttribute('style', 'background-color:#1eff00');
};

EditorUi.prototype.setStatusNotSaved = function()
{
    this.statusContainer.innerHTML = "Not Saved";
    this.statusContainer.setAttribute('style', 'background-color:red');
};
/**
 * Creates a new toolbar for the given container.
 */
 ...
 */
EditorUi.prototype.createSidebar = function(container,stereotype)
{
	return new Sidebar(this, container,stereotype);
};

/**
 * Creates a new sidebar for the given container.
 */
EditorUi.prototype.createFormat = function(container,stereotype)
{
	return new Format(this, container, stereotype);
};
