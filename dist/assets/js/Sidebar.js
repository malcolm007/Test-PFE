 ...
 */
function Sidebar(editorUi, container, stereotype)
{
...
Sidebar.prototype.init = function()
{
	...
	this.addStereotypesPalette(true,this.stereotype );
    this.addEntityPalette(true);
    this.addAssociationPalette(true);
 ...
 * Adds the general palette to the sidebar.
 */
Sidebar.prototype.addStereotypesPalette = function(expand , contenu)
{
	// Avoids having to bind all functions to "this"
	var sb = this;
	// Default tags
	...
	var fns = [];
	var i=0;
	var cont = contenu.stereotypes;
	var stereotype;
	for(j = 0; j<cont.length ; j++)
	{
		if(cont[j].superClass === "Mandatory"){
			stereotype = cont[j];
			fns[i] = this.addEntry(dt + 'object instance '+cont[j].name, function(content , stereotype)
			{
				...
				node.setAttribute('label', '<<'+stereotype.name+' >>');
				node.setAttribute('Type', 'Stereotype');
				var v11 = new mxCell(node,new mxGeometry(80, 1, 0, 0), 'align=center;verticalAlign=top;');
				//v11.geometry.relative = true;
				v11.geometry.offset = new mxPoint(0, -39);
				v11.vertex=true;
				v11.setConnectable(false);

				var doc = mxUtils.createXmlDocument();
				var node = doc.createElement('Element');
				node.setAttribute('label', 'ClassName');
				...
				var cell = new mxCell(node, new mxGeometry(0, 0, 160, 90),
					'swimlane;fontStyle=1;align=center;verticalAlign=bottom;childLayout=stackLayout;horizontal=1;startSize=40;spacingBottom=0;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;','class');
				cell.vertex = true;
				cell.insert(v11);
				
				var doc = mxUtils.createXmlDocument();
				var node = doc.createElement('Element');
				node.setAttribute('label', '+ field: type');
				...
				var node = doc.createElement('Element');
				node.setAttribute('label', '+ method(type): type');
		...
		{
			var v11 = new mxCell('',new mxGeometry(1, 1, 0, 0), 'align=center;verticalAlign=top;');
			
			//v11.geometry.relative = true;
			v11.geometry.offset = new mxPoint(0, -49);
			v11.vertex=true;
			v11.setConnectable(false);
            var doc = mxUtils.createXmlDocument();
         	var node = doc.createElement('Element');
        	...
        	node.setAttribute('Type', 'Class');
			var cell = new mxCell(node, new mxGeometry(0, 0, 160, 90),
		    	'swimlane;fontStyle=1;align=center;verticalAlign=middle;childLayout=stackLayout;horizontal=1;startSize=50;spacingBottom=5;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;','class');
			cell.vertex = true;
			cell.insert(v11);
			cell.insert(field.clone());
            cell.insert(field.clone());
		...
		this.addEntry(dt + 'section subsection', function()
		{
			var cell = new mxCell('Classname', new mxGeometry(0, 0, 140, 110),
		    	'swimlane;fontStyle=0;childLayout=stackLayout;verticalAlign=top;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;');
			cell.vertex = true;
			cell.insert(field.clone());
			cell.insert(field.clone());
			cell.insert(field.clone());
        ...
        this.addEntry(dt + 'item member method function variable field attribute label', function()
        {
            return sb.createVertexTemplateFromCells([sb.cloneCell(method)], method.geometry.width, method.geometry.height, 'Item 2');
        }),
   		this.addEntry(dt + 'item member method function variable field attribute label', function()
		{
        ...
        */
	this.addPaletteFunctions('Stereotype', 'Stereotype', expand || false, fns , contenu.stereotypes);
};

Sidebar.prototype.addEntityPalette = function(expand)
{
	// Avoids having to bind all functions to "this"
	var sb = this;
    ...
    node.setAttribute('label', '+ field: type');
	node.setAttribute('Type', 'Attribute');
	node.setAttribute('AddedBy', 'User');
	node.setAttribute('Stereotype', '');
	var field = new mxCell(node, new mxGeometry(0, 0, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	field.setConnectable(false);
	...
	var fns = [
   		this.addEntry(dt + 'object instance', function()
		{
			...
			node.setAttribute('Type', 'Class');
			var cell = new mxCell(node, new mxGeometry(0, 0, 160, 90),
		    	'swimlane;fontStyle=1;align=center;verticalAlign=bottom;childLayout=stackLayout;horizontal=1;startSize=26;spacingBottom=5;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;','class');
			cell.vertex = true;
			cell.insert(v11.clone());
			cell.insert(field.clone());
            cell.insert(field.clone());
			cell.insert(divider.clone());
			cell.insert(method.clone());
		...
		{
			var cell = new mxCell('Classname', new mxGeometry(0, 0, 140, 110),
		    	'swimlane;fontStyle=0;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;swimlaneFillColor=#ffffff;');
			cell.vertex = true;
			cell.insert(field.clone());
			cell.insert(field.clone());
			cell.insert(field.clone());
	...
	this.addPaletteFunctions('Entity', mxResources.get('uml')+' Entity', expand || false, fns);
};

Sidebar.prototype.addAssociationPalette = function(expand)
{
    // Avoids having to bind all functions to "this"
    var sb = this;
    ...
    var fns = [
        ...
        this.addEntry('uml association', function()
        {
            ...
            var node = doc.createElement('Element');
            node.setAttribute('label', '');
            node.setAttribute('Type', 'Association');
            var edge = new mxCell(node, new mxGeometry(0, 0,0, 0), 'endArrow=none;html=1;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            edge.geometry.setTerminalPoint(new mxPoint(410, 0), false);
            ...
            var divider = new mxCell(node, new mxGeometry(0, 0, 40,1), 'line;strokeWidth=1;fillColor=none;align=middle;verticalAlign=middle;points=[[1,0.5],[0,0.5],[0.5,0],[0.5,1]];');
            divider.geometry.relative = true;
            divider.vertex = true;
            divider.setConnectable(true);
			edge.insert(divider);

            var doc = mxUtils.createXmlDocument();
            var node = doc.createElement('Element');
            node.setAttribute('label', '1 .. 1');
            node.setAttribute('Type', 'Cardinalite');
            var cell1 = new mxCell(node, new mxGeometry(-1, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=14;');
            ...
            var node = doc.createElement('Element');
            node.setAttribute('label', '');
            node.setAttribute('Type', 'CardinaliteLabel');
            var cell3 = new mxCell(node, new mxGeometry(-1, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=14;');
            ...
            var node2 = doc2.createElement('Element');
            node2.setAttribute('label', '1 .. 1');
            node2.setAttribute('Type', 'Cardinalite');
            var cell2 = new mxCell(node2, new mxGeometry(1, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=top;labelBackgroundColor=#ffffff;fontSize=14;');
            ...
            var doc2 = mxUtils.createXmlDocument();
            var node2 = doc2.createElement('Element');
            node2.setAttribute('label', '');
            node2.setAttribute('Type', 'CardinaliteLabel');
            var cell4 = new mxCell(node2, new mxGeometry(1, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=14;');
        ...
        this.addEntry('uml aggregation', function()
        {
            ...
            node.setAttribute('Type', 'Association');
            var edge = new mxCell(node, new mxGeometry(0, 0, 0, 0), 'endArrow=none;html=1;;startArrow=diamondThin;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            ...
            node.setAttribute('label', '1 .. 1');
            node.setAttribute('Type', 'Cardinalite');
            var cell1 = new mxCell(node, new mxGeometry(-0.85, 0, 0, 0), 'resizable=0;html=1;align=left;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=14;');
            cell1.geometry.relative = true;
            cell1.setConnectable(false);
            cell1.vertex = true;
            edge.insert(cell1);
            ...
            node2.setAttribute('label', '');
            node2.setAttribute('Type', 'CardinaliteLabel');
            var cell4 = new mxCell(node2, new mxGeometry(0.85, 0, 0, 0), 'resizable=0;html=1;align=right;verticalAlign=bottom;labelBackgroundColor=#ffffff;fontSize=14;');
            cell4.geometry.relative = true;
            cell4.setConnectable(false);
            cell4.vertex = true;
            edge.insert(cell4);
            ...
            return sb.createEdgeTemplateFromCells([edge], 260, 0, 'Aggregation 1');
        }),
        this.addEntry('uml aggregation ', function()
        {
            var doc = mxUtils.createXmlDocument();
            ...
            node.setAttribute('label', 'Text');
            node.setAttribute('Type', 'Association');
            var edge = new mxCell(node, new mxGeometry(0, 0, 0, 0), 'startArrow=none;html=1;;endArrow=diamondThin;endSize=14;endFill=0;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
            edge.geometry.relative = true;
            edge.edge = true;
            ...
            return sb.createEdgeTemplateFromCells([edge], 260, 0, 'Aggregation 2');
        }),
        this.addEntry('uml composition', function()
        {
            ...
            node.setAttribute('label', 'Text');
            node.setAttribute('Type', 'Association');
            var edge = new mxCell(node, new mxGeometry(0, 0, 0, 0), 'endArrow=none;html=1;;startArrow=diamondThin;startSize=14;startFill=1;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
            edge.geometry.relative = true;
            edge.edge = true;
            ...
            return sb.createEdgeTemplateFromCells([edge], 260, 0, 'composition 1');
        }),
        this.addEntry('uml composition ', function()
        {
            var doc = mxUtils.createXmlDocument();
            ...
            node.setAttribute('label', 'Text');
            node.setAttribute('Type', 'Association');
            var edge = new mxCell(node, new mxGeometry(0, 0, 0, 0), 'startArrow=none;html=1;;endArrow=diamondThin;endSize=14;endFill=1;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
            edge.geometry.relative = true;
            edge.edge = true;
            ...
            return sb.createEdgeTemplateFromCells([edge], 260, 0, 'composition 2');
        }),
        this.addEntry('uml generalisation ', function()
        {
            var doc = mxUtils.createXmlDocument();
            var node = doc.createElement('Element');
            node.setAttribute('label', '');
            node.setAttribute('Type', 'Generalisation');
            var edge = new mxCell(node, new mxGeometry(0, 0, 0, 0), 'endArrow=block;endSize=16;endFill=0;html=1;edgeStyle=orthogonalEdgeStyle;');
            edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
            edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
            edge.geometry.relative = true;
            edge.edge = true;

            return sb.createEdgeTemplateFromCells([edge], 260, 0, 'Generalization');
        }),
    ...
    this.addPaletteFunctions('uml2', mxResources.get('uml')+' Association', expand || false, fns);
};
/**
 ...
 */
Sidebar.prototype.addPaletteFunctions = function(id, title, expanded, fns , stereotype)
{
	if(stereotype !== undefined ){
	this.addPalette(id, title, expanded, mxUtils.bind(this, function(content)
	{
		var j=0;
		for (var i = 0; i < stereotype.length; i++)
		{
			if(stereotype[i].superClass === "Mandatory"){
				content.appendChild(fns[j](content , stereotype[i]));
				j++;
			}
		}
	}));
